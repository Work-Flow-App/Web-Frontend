...
import { getWorkflowStatusLabel, getActivityConfig, ACTIVITY_CONFIG } from '../../../../types';
import * as S from '../../JobDetailsPage.styles';
import * as OV from '../overview/OverviewField.styles';
      ...
      <S.ActivityTimelineSection>
        ...
        <S.GanttChartBody>
          {steps.map((step, stepIdx) => {
            ...
            const statusLabel = getWorkflowStatusLabel(step.status || '') || step.status || 'Pending';
