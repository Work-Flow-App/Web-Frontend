...
export const PageList: React.FC = () => {
  ...
  // Automatically trigger customer creation modal if ?openAddModal=true query parameter is present in URL
  useEffect(() => {
  ...
  }, [location.search, loading, navigate, handleAddCustomer]);
