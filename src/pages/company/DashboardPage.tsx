 ...
 * Dashboard Page
 *
 * Main dashboard/home page of the company section.
  ...
  return (
    <Box sx={{ padding: rem(32) }}>
      <PageHeader>
        ...
        <PageSubtitle>Welcome back! Here's an overview of your company</PageSubtitle>
      </PageHeader>
      ...
      <ContentBox>
        <Box sx={{ textAlign: 'center', minHeight: rem(300), display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
          ...
          >
            Use the sidebar to navigate to different sections like Workers, Jobs, and Clients.
            <br />
            The sidebar and top navigation will persist as you navigate.
          </Typography>
        </Box>
      </ContentBox>
    </Box>
